const API = {
    async getStats() {
        try {
            ...
            return {
                success: false,
                counters: { total: 0, normal: 0, ddos: 0, port_scan: 0, dns_spoof: 0, mitm: 0 },
                modelMetrics: { accuracy: 0, precision: 0, recall: 0, f1: 0 },
                uptime: 0,
                trafficRate: 0
            };
        }
    ...
    async getNetwork() {
        try {
            ...
            return { success: false, components: [], connections: [] };
        }
    },
    ...
    protocolName(type) {
        const map = { 0: 'TCP', 1: 'UDP', 2: 'ICMP', 3: 'SCTP' };
        return map[type] || 'TCP';
    }
};
